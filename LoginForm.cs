...
class FormLogin : Form
{
    ...
    public FormLogin()
    {
        ...
        this.TextboxPw.Font = new Font("MS UI Gothic", 15);
        this.TextboxPw.MaxLength = 4;
        this.Controls.Add(this.TextboxPw);

        //ログインボタン
        this.ButtonLogin = new Button();
        this.ButtonLogin.Location = new Point(255, 380);
        this.ButtonLogin.Size = new Size(110, 40);
        this.ButtonLogin.Font = new Font("MS UI Gothic", 10);
        this.ButtonLogin.Text = "ログイン";
        this.ButtonLogin.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
        this.Controls.Add(this.ButtonLogin);
        //終了ボタン
        this.ButtonExit = new Button();
        this.ButtonExit.Location = new Point(395, 380);
        this.ButtonExit.Size = new Size(110, 40);
        this.ButtonExit.Font = new Font("MS UI Gothic", 10);
